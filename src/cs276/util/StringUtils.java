...
public class StringUtils {
	...
	public static double jaccard(String term1, String term2) {
		...
		int intersectionSize = 0, unionSize = bigrams1.size() + bigrams2.size();

		for (String bigram1 : bigrams1) {
			for (String bigram2 : bigrams2) {
	...
	public static String removeVowels(String word) {
		...
		return word.charAt(0) +
			middle.replaceAll("a", "").replaceAll("e", "").replaceAll("i", "").replaceAll("o", "").replaceAll("u", "") +
