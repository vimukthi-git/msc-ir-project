...
public class SpellingScorer {
	...
	public static void main(String[] argv) {
			...
			for (String misspelling : entry.getValue()) {
				...
				if (!corrections.isEmpty() && corrections.get(0).equals(word)) {
                    ...
                    if(corrections.contains(word)) {
                        nNotFirstSuggestion++;
                        //System.out.println("Not first suggestion -- word = " + word + ", misspelling = " + misspelling);
                    } else {
                        nNotFound++;
                        //System.out.println("Not found -- word = " + word + ", misspelling = " + misspelling);
                    }
                }
				nTotal += 1;
			}
        ...
        System.out.println("First suggestion correct : " + nCorrect);
        System.out.println("Not first suggestion : " + nNotFirstSuggestion);
        System.out.println("Not found : " + nNotFound);
	}
